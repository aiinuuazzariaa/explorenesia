...
public class TouristData {
    public static ArrayList<Tourist> getData() {
        ...
        list.add(new Tourist("Borobudur Temple", "Central Java",
                ...
                R.drawable.borobudur,  "https://maps.app.goo.gl/LgxwPB5MvEUPeNkVA", 4.7f));
        ...
        list.add(new Tourist("Bunaken Marine Park", "North Sulawesi",
                ...
                R.drawable.bunaken, "https://maps.app.goo.gl/w9zJxigHURc54RTr8", 4.7f));
        ...
        list.add(new Tourist("Derawan Islands", "East Kalimantan",
                ...
                R.drawable.derawan, "https://maps.app.goo.gl/NoSDgbRjYhgEw3io9", 4.7f));
        ...
        list.add(new Tourist("Dieng Plateau", "Central Java",
                ...
                R.drawable.dieng, "https://maps.app.goo.gl/ugFVgV1qUa8b4myS7", 4.6f));
        ...
        list.add(new Tourist("Ijen Crater", "East Java",
                ...
                R.drawable.ijen, "https://maps.app.goo.gl/i9xGwiHcDT6Vh5K5A", 4.8f));
        ...
        list.add(new Tourist("Kelimutu Lake", "East Nusa Tenggara",
                ...
                R.drawable.kelimutu, "https://maps.app.goo.gl/i9xGwiHcDT6Vh5K5A", 4.8f));
        ...
        list.add(new Tourist("Komodo Island", "East Nusa Tenggara",
                ...
                R.drawable.komodo, "https://maps.app.goo.gl/WGxDuCvP5JMgAaZx9", 4.2f));
        ...
        list.add(new Tourist("Kuta Beach", "Bali",
                ...
                R.drawable.kuta, "https://maps.app.goo.gl/1TSKBB2uwwScPkz78", 4.5f));
        ...
        list.add(new Tourist("Labuan Bajo", "East Nusa Tenggara",
                ...
                R.drawable.labuan_bajo, "https://maps.app.goo.gl/Q1NbouBS7X5nEpD26", 4.5f));
        ...
        list.add(new Tourist("Lake Toba", "North Sumatra",
                ...
                R.drawable.toba, "https://maps.app.goo.gl/P5dEpUEQetJSLgFP8", 4.6f));
        ...
        list.add(new Tourist("Lake Sentani", "Papua",
                ...
                R.drawable.sentani, "https://maps.app.goo.gl/quhWt97Ui9yKB15t5", 4.5f));
        ...
        list.add(new Tourist("Mentawai Islands", "West Sumatra",
                ...
                R.drawable.mentawai, "https://maps.app.goo.gl/qL3SEAyrE7AR9gBU7", 5.0f));
        ...
        list.add(new Tourist("Mount Bromo", "East Java",
                ...
                R.drawable.bromo, "https://maps.app.goo.gl/Tc83FJ4eCo6kKxCA7", 4.7f));
        ...
        list.add(new Tourist("Mount Rinjani", "West Nusa Tenggar",
                ...
                R.drawable.rinjani, "https://maps.app.goo.gl/jW4bYdA7tBvTNhB39", 4.6f));
        ...
        list.add(new Tourist("Raja Ampat Islands", "South West Papua",
                ...
                R.drawable.raja_ampat, "https://maps.app.goo.gl/caWBftYLr5hVnrWU6", 4.6f));
        ...
        list.add(new Tourist("Tanah Lot", "Bali",
                ...
                R.drawable.tanah_lot, "https://maps.app.goo.gl/BVUQDvn2QY7S7Twz9", 4.7f));
        ...
        list.add(new Tourist("Tanjung Pandan", "Bangka Belitung Islands",
                ...
                R.drawable.belitung, "https://maps.app.goo.gl/mNHj4cGPMN3gWndQ7", 4.5f));
        ...
        list.add(new Tourist("Tanjung Puting National Park", "Central Kalimantan",
                ...
                R.drawable.tanjung_puting, "https://maps.app.goo.gl/5bTuQLAnm6Pps2eC9", 4.7f));
        ...
        list.add(new Tourist("Ubud Palace", "Bali",
                ...
                R.drawable.ubud, "https://maps.app.goo.gl/kfNGdR1mZxM6cVoj8", 4.3f));
        ...
        list.add(new Tourist("Wakatobi National Park", "Southeast Sulawesi",
                ...
                R.drawable.wakatobi, "https://maps.app.goo.gl/zbGcr2qvJXzxdhv46", 4.5f));
